...
correct_function = """def scaffold_project(project_id: str, clone_url: str, framework: str) -> dict:
    \"\"\"
...
# replace everything from def scaffold_project to except Exception as e:
pattern = re.compile(r'def scaffold_project.*?except Exception as e:', re.DOTALL)
new_content = pattern.sub(correct_function, content)

with open(filepath, "w", encoding="utf-8") as f:
    f.write(new_content)

print("Fixed gitlab_api.py")
